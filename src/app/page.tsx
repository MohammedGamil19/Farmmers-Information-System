...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* ── CTA ───────────────────────────────────────────────────────────────── */}
      <section className="py-24 px-6 bg-gradient-to-br from-green-700 to-emerald-600 text-white text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-white rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-white rounded-full translate-y-1/2 -translate-x-1/2" />
        </div>
        <div className="relative z-10">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-4">Siap Memulai?</h2>
          <p className="text-green-100 mb-10 text-lg max-w-xl mx-auto">Digitalisasi pertanian hidroponik desa Anda sekarang dan tingkatkan hasil panen bersama.</p>
          <Link
            href="/login"
            className="inline-flex items-center gap-2 bg-white text-green-700 px-10 py-4 rounded-xl font-bold text-lg hover:bg-green-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5"
          >
            Masuk ke Sistem →
          </Link>
        </div>
